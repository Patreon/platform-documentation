...
------------ | ---- | -----------
user | [User](/#user-v2) | The user who's address this is.
...
app_meta | string | Any metadata the third-party app included with this benefit on creation. Can be null.

### Benefit Relationships

Relationship | Type | Description
------------ | ---- | -----------
tiers | array[[Tier](/#tier)] | The Tiers the benefit has been added tp
...
creator | [User](/#user-v2) | The campaign creator.
...
name | string | The name provided by the client creator in setup.
description | string | The description provided by the client creator in setup.
author_name | string | The author name provided by the client creator in setup. Can be null.
domain | string | The domain provided by the client creator in setup. Can be null.
version | integer | The Patreon API version the client is targeting.
icon_url | string | The icon used in the OAuth authorization flow. Can be null.
privacy_policy_url | string | The privacy policy provided by the client creator. Can be null.
tos_url | string | The terms of service provided by the client creator. Can be null.
...
apps | array[Platform-App] | (Alpha) The apps that the client controls.
